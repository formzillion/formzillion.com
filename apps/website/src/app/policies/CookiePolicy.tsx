export default function CookiePolicy() {
  return (
    <div className="font-[Satoshi] text-black bg-slate-300 border-2 p-5">
      <h1>Cookie Policy for Formzillion</h1>
      <p>This is the Cookie Policy for Formzillion, accessible from https://formzillion.com</p>
      ...
      <ul>
        <li>Email: support@formzillion.com or support@zillionstack.com</li>
        <li>By visiting this link: https://formzillion.com/contact-us</li>
        <li>Phone: +1(587)988-9633</li></ul>
    </div>
  )
}
...
const Avatar = ({ teamSlug }: any) => {
  ...
  const avatar = get(parsedData, "0.avatar", "");
  teamSlug = get(parsedData, "0.slug", "");
  const teamName = get(parsedData, "0.name", "");
          ...
          <div className="mt-1 items-center justify-center">
            {isEmpty(avatar) && isEmpty(base64Image) ? (
              ...
              <Image
                ...
                alt="err"
                className="h-20 w-20 border border-gray-700 object-contain rounded-full"
                height={20}
                width={20}
              />
            )}

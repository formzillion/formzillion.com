...
![](/integrations/webhooks/connection.png)
...
![](/integrations/webhooks/task.png)
...
<Callout type="info" emoji="ℹ️">
  **Note**: You can generate the instant webhook endpoint using
  [Beecepter](https://beeceptor.com/)
</Callout>

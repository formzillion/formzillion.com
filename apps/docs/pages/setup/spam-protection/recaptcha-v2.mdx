...
<br />
<img src="/setup/spam-protection/re-captcha-on-click.gif" alt="recaptcha" width="300px" />
...
After you login to Google reCAPTCHA Console, create a new site. Select reCAPTCHA v2 and add your domains.

<br />
<p align="center">
  <img src="/setup/spam-protection/re-captcha-v2-setup.png" alt="recaptcha-v2-setup" width="720px" />
</p>

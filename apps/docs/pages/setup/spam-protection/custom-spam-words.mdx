...
1. Goto [formzillion.com](https://formzillion.com/)
2. Create a form
  ...
  <body>
    <div class="mx-auto flex h-[100vh] max-w-7xl items-center justify-center">
      <div class="w-[600px] border border-gray-100 px-10 py-8 shadow">
        ...
        <h4 class="text-center text-base text-gray-500 mt-4">
          Formzillion.com HTML Form with Google invisible reCaptcha(v3)
        </h4>
        <form
          id="form"
          class="my-6"
          action="http://localhost:3000/f/clgqj0fyo0003v56wz5vtkjcp"
          method="POST"
        >
